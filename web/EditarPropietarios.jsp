...
<%
    ...
    if (sesionOk.getAttribute("nombre") == null) {
        ...
        nombree = (String) sesionOk.getAttribute("nombre");
...
<html>
    <head>
        ...
        <link type="text/css" href="css/estiloreditarpropietario.css" rel="stylesheet" />
...
<div id='mensajeIN'>                
                <b>Bienvenido Señor (a):<%=nombree%>&nbsp;&nbsp;</b>
            ...
            <form name="elim"  id="elim" method="POST" action="ControlarPropietario"> 
                <div id="cajabuscar" >
                    <div>
                        <br>
                        <br>
                        <label class="busqueda" for="element_1">Digite el Código a editar:</label>
                        <br>
                        <br>
                    </div>
                    <div>
                        <input id="cod" name="cod" class="camp" type="text" maxlength="255" value="" required autofocus/> 
                    </div>
                </div>
                <div id="btnbuscar">
                    <br>
            ...
            <form name="reg"  id="reg" method="POST" action="ControlarPropietario"> 
                ...
                <fieldset id="marcos" >
                    ...
                    <div class="principal" align="CENTER" >
                        <ul >
                            <div id="prifila">
                                ...
                                <div>
                                    <input id="cod" name="cod" class="element text medium" type="text" maxlength="255" value="<%=cod%>" disabled=""/> 
                                </div> 
                                </li>	
                                <li id="li_8" >
                        ...
                        <div>
                            <input id="ape" name="ape" class="element text medium" type="text" maxlength="255" value="<%=apellidos%>"/> 
                        </div> 
                        </li>
                    ...
                    <div id="segfila">
                        ...
                        <div>
                            <input id="doc" name="doc" class="element text medium" type="text" maxlength="255" value="<%=doc%>"/> 
                        </div> 
                        </li>
                        <li id="li_4" >
                    ...
                    <div id="terfila">
                        ...
                        <div>
                            <input id="carrera" name="carrera" class="element text medium" type="text" maxlength="255" value="<%=carrera%>"/> 
                        </div> 
                        </li>
                ...
                <div class="btn">
                    <input type="submit" class="button medium blue" id = "guardar" name="guardar" value="GUARDAR"/>
                    <br>
                    <br>       
                    <br> 
